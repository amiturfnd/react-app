  ...
  render() {
    return (
      <section className="page-not-found">
        ...
        <div>
          <div className="page-not-found__heading-1">404</div>
          <div className="page-not-found__heading-2">The page not found</div>
          <div><Link to="/katacoda/courses">Go to home page</Link></div>
        </div>
      </section>
    );
  }
